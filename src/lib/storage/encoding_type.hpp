...
enum class EncodingType : uint8_t { Unencoded, Dictionary, RunLength, FixedStringDictionary, FrameOfReference, LZ4, GdV1, GdV1Fixed };
...
inline static std::vector<EncodingType> encoding_type_enum_values{
    ...
    EncodingType::GdV1,             EncodingType::GdV1Fixed
  };
...
constexpr auto supported_data_types_for_encoding_type = hana::make_map(
    ...
    hana::make_pair(enum_c<EncodingType, EncodingType::GdV1>, hana::tuple_t<int32_t>),
    hana::make_pair(enum_c<EncodingType, EncodingType::GdV1Fixed>, hana::tuple_t<int32_t>)
  );
